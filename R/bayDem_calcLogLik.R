...
#   generalized in the future beyond Gaussian mixtures. The observation matrix
#   (see bayDem_calcObsMatrix) is input do reduce computation.
#
# Example calls(s)
#
#   logLik <_ bayDem_calcLogLik(ygrid,th,obsMat)
# 
# Input(s)
...
#   th            matrix         [numObs x numGrid] The observation matrix (see
#                                bayDem_calcObsMatrix)
#
# Output(s)
#   Name          Type           Description
#   logLik        scalar         The log-likelihood, log( p(D|th,alpha) )

bayDem_calcLogLik <- function(ygrid,th,obsMat) {
